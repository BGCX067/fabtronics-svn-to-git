...
static void MouseFuncHandler(int button, int state,int x, int y)
{
	...
	{
//		camera1.mouseUpdate( glm::vec2( x,y ), true);
	}
}
static void MotionFuncHandler(int x, int y)
{
	demo1.MotionFuncHandler(x, y);
}
...
void display()
{
	//demo1.color = glm::vec3(0.1,0.2,0.2);
	demo1.display();
}

void display1()
{
	demo2.color = glm::vec3(0.0,0.4,0.2);
	demo2.display();
}
