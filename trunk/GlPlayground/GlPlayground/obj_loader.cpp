...
void MeshIndexedDesc::CalcNormals()
{
...
MeshIndexedDesc OBJModel::ToMeshIndexedDesc()
{
    MeshIndexedDesc result;
    MeshIndexedDesc normalModel;
...
unsigned int OBJModel::FindLastVertexIndex(const std::vector<OBJIndex*>& indexLookup, const OBJIndex* currentIndex, const MeshIndexedDesc& result)
{
